...
sub CommitRequest {
  my ($self, %args) = @_;
  my $class = 'Google::Storage::DataStore::CommitRequest';
...
sub Key {
  my ($self, %args) = @_;
  my $class = 'Google::Storage::DataStore::Key';
...
Google::Storage::DataStore - Google Datastore Client Library for Perl

=head1 SYNOPSIS

    use Google::Storage::DataStore;
    ...
    # create a instance
    my $bq = Google::Storage::DataStore:create(
